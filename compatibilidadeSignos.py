...
a palavra "FIM".
No final, seu programa deve exibir o percentual de pares compatíveis e a  
palavra com o menor número de letras
-->função contaLetra: recebe uma string e retorna a quantidade de letras não acentuadas desta string. 
'''
